package chemister.character;

import basemod.BaseMod;
import basemod.abstracts.CustomEnergyOrb;
import basemod.abstracts.CustomPlayer;
import basemod.animations.SpriterAnimation;
import chemister.cards.basic.Defend;
import chemister.cards.basic.FuturesightFumes;
...
import static chemister.ChemisterMod.characterPath;
...
public class Chemister extends CustomPlayer {
    ...
    //Strings
    private static final String ID = makeID("Chemister"); //This should match whatever you have in the CharacterStrings.json file
    ...
    public static class Meta {
        ...
        @SpireEnum
        public static PlayerClass CHEMISTER;
        @SpireEnum(name = "CHEMISTER_COLOR") // These two MUST match. Change it to something unique for your character.
        public static AbstractCard.CardColor CARD_COLOR;
        @SpireEnum(name = "CHEMISTER_COLOR") @SuppressWarnings("unused")
        ...
        public static void registerCharacter() {
            BaseMod.addCharacter(new Chemister(), CHAR_SELECT_BUTTON, CHAR_SELECT_PORTRAIT);
        }
    }
    ...
    public Chemister() {
        super(getNames()[0], Meta.CHEMISTER,
    ...
    public ArrayList<String> getStartingDeck() {
        ...
        retVal.add(Defend.ID);
        retVal.add(Defend.ID);
        retVal.add(LavaSpill.ID);
        retVal.add(FuturesightFumes.ID);
    ...
    public ArrayList<String> getStartingRelics() {
        ...
        retVal.add(ChemisterJournal.ID);
        retVal.add(FlaskTerra.ID);
        retVal.add(FlaskIgnis.ID);
        retVal.add(FlaskAqua.ID);
