...
import chemister.powers.CavitationPower;
import chemister.util.CardStats;
import com.megacrit.cardcrawl.characters.AbstractPlayer;
import com.megacrit.cardcrawl.monsters.AbstractMonster;

public class Cavitation extends CatalystCard {
    public static final String ID = makeID(Cavitation.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        applySelf(new CavitationPower(p, magicNumber));
    }
}
